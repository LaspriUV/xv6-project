...
struct proc
{
  ...
  uint arrival_time;   // primer tick RUNNABLE
  uint finish_time;    // tick cuando termina (ZOMBIE)
  uint run_ticks;      // ticks en RUNNING
  uint wait_ticks_tot; // ticks totales en RUNNABLE
  uint ctx_switches;   // veces que fue elegido por scheduler
